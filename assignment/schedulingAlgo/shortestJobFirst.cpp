...
// With this algorithm , it is the job with the shortest time to execute that will make use of the resources 

// even if there was already a process  making use of the resources for its execution , it will be preempted so that the shortest job will have to execute 
// reason for it being a preemptive scheduling algorithm 
#include <iostream>
using namespace std;

// This program swaps the shortest job with job that is currently execution 
